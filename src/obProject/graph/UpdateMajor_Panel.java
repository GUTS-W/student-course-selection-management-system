...
import javax.swing.*;
import java.awt.*;
public class UpdateMajor_Panel extends JPanel{
    ...
    JLabel operation=new JLabel("此时您进行的操作是 更新专业");
    ...
    public void init(){
        ...
        getPreNameText().setBounds(610,280,190,38);

        getAddNameText().setBounds(610,380,190,38);

        JLabel departmentNameLabel=new JLabel("待更新专业所在院系名");
        JLabel preNameLabel=new JLabel("待更新专业名称");
        JLabel addNameLabel=new JLabel("更新后专业名称");
        ...
        preNameLabel.setBounds(300,280,280,40);
    ...
    public JTextField getPreNameText() {return preNameText;}
