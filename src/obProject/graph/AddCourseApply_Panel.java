...
public class AddCourseApply_Panel extends JPanel{
    ...
    private JLabel operation=new JLabel("此时您进行的操作是 申请开课信息");
...
//设置边框颜色
        ...
        JLabel addCidLabel=new JLabel("待申请课程编号");
        JLabel addNameLabel=new JLabel("待申请课程名称");
        JLabel addCreditLabel=new JLabel("待申请课程学分");
        JLabel addTypeLabel=new JLabel("待申请课程类型");
        JLabel addDepartmentLabel=new JLabel("待申请课程所属院系");
        ...
        getApplyButton().setBounds(420,580,200,50);
