...
import javax.swing.*;
import java.awt.*;
public class UpdateTeacher_Panel extends JPanel
{
    ...
    JLabel operation=new JLabel("此时您进行的操作是 更改教师信息");
    public void init(){
        setLayout(null);
...
//设置边框颜色
        ...
        //标签及其摆放的位置
        JLabel addTidLabel=new JLabel("待查询教师编号");
        JLabel addNameLabel=new JLabel("教师姓名");
        JLabel addSexLabel=new JLabel("教师性别");
        JLabel addDepartLabel=new JLabel("教师学院");
        JLabel addAgeLabel=new JLabel("教师年龄");
        ...
        getUpdateButton().setBounds(700,450,200,50);
    ...
    public void setAddAgeText(JTextField addMajorText) {
        this.addAgeText = addMajorText;
    }
